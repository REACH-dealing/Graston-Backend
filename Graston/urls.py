...
urlpatterns = [
    ...
    path("auth/send-otp2email/<str:email>/", VerifyEmail.as_view({"get": "send_otp2email"})),
    path("auth/verify-email/<str:email>/<int:otp_number>/", VerifyEmail.as_view({"post": "verify_email"})),
